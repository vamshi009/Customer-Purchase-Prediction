...
clf = GradientBoostingClassifier(n_estimators=100, learning_rate=1, max_depth=10, random_state=0)
...
write_to_file(finalrows, "Vamshi_Test_Submission_xgboost_0.2.csv")
